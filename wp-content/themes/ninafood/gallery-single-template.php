...
if ($second_query->have_posts()) : while ($second_query->have_posts()) : $second_query->the_post(); ?>
    <div class="row">
        <div class="col-sm-12">
            <a onclick="history.go(-1)" class="pull-left back-button hidden-xs">&larr; Back to Gallery</a>
        ...
        <?php foreach( $posts as $attachment ) {
            ...
            <div class="col-sm-4 col-md-3">
                <a rel="gallery_fancybox" href="<?php echo $image_attributes_large[0]; ?>" title="<?php echo get_post_meta( $attachment->ID, $key, true ); ?>">
                    <img  class="gallery-image" style="width: 100%;height:auto;" alt="" title="<?php echo get_post_meta( $attachment->ID, $key, true ); ?>" src="<?php echo $image_attributes[0]; ?>" rel="<?php echo $image_attributes_full[0]; ?>" />
                </a>

                <p class="caption"><?php echo get_post_meta( $attachment->ID, $key, true ); ?>&nbsp;</p>
            </div>
