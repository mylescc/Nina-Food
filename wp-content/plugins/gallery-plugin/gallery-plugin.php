...
if( ! function_exists( 'register_gllr_settings' ) ) {
	function register_gllr_settings() {
		...
		$gllr_option_defaults = array(
			...
			'gllr_custom_size_px'			=> array(array( 263, 9999 ), array( 263, 9999 ) ),
			'border_images'						=> 1,
		...
		if ( function_exists( 'add_image_size' ) ) {
			add_image_size( 'album-thumb', 263, 363, true);
			add_image_size( 'photo-thumb', 263, 363, true);
		}
	}
}
						...
						$count_image_block = 0; ?>
                            ...
                            <?php } ?>
                                    <div class="col-sm-3">
										...
										<caption style="width:<?php echo $gllr_options['gllr_custom_size_px'][1][0]+$gllr_border_images; ?>px; <?php if( 0 == $gllr_options["image_text"] ) echo "visibility:hidden;"; ?>" class="gllr_single_image_text"><?php echo get_post_meta( $attachment->ID, $key, true ); ?>&nbsp;</caption>
									</div>
